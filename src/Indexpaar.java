...
public class Indexpaar implements Serializable, Comparable{
    ...
    public static void writeIndexPaar(Indexpaar zuschreiben) {
        ...
        final String artikel_idx = "D:\\DBPrak1\\src\\ARTIKEL.IDX";
        try{
    ...
    //Methode zum Suchen der artnr
    //entweder sie wird gefunden oder halt Meldung dass sie nicht existiert
    public static void searchIndexPaare(ArrayList<Indexpaar> il, ArrayList<Artikel> al, Scanner s){
        System.out.println("Geben Sie eine Artikelnummer ein..\n");
        long searchnr = Long.parseLong(s.nextLine());
        long offset = -1;
        ...
        if(offset != -1){
            System.out.println("Sucheregebnis:");
